...
def create_ec2():
    re_info = command_execute_utils.runcmd("aws ec2 run-instances \\\n"
...
def get_public_ip_by_instance_id(instance_id):
    return command_execute_utils.runcmd("aws ec2 describe-instances --instance-ids" + " " + instance_id +
...
def terminate_ec2(instance_id):
    return command_execute_utils.runcmd(["aws ec2 terminate-instances --instance-ids " + instance_id])
